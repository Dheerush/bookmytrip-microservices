...
import { createHotelHandler, deductHotelRoomsHandler, deleteHotelHandler, getHotelByIdHandler, listAllHotelsHandler, listHotelSuggestionsHandler, searchHotelsHandler, updateHotelHandler } from '../controllers/hotel.controller';
...
router.get('/suggestions', searchLimiter, listHotelSuggestionsHandler);
